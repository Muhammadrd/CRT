    ...
    <div class="container" style="width: fit-content; margin-left:20px; width:500px;">
        ...
        <form action="/crud/<?= $crud_mahasiswa['id'] ?>/update" method="post">
            <div class="mb-3" style="margin-top: 10px;">
                ...
                <input type="text" class="form-control" name="nama" value="<?= $crud_mahasiswa['nama'] ?>">
            </div>
            <div class="mb-3">
                <label for="kelas" class="form-label">Kelas</label>
                <input type="text" class="form-control" name="kelas" value="<?= $crud_mahasiswa['kelas'] ?>">
            </div>
            <div class="mb-3">
                <label for="jurusan" class="form-label">Jurusan</label>
                <input type="text" class="form-control" name="jurusan" value="<?= $crud_mahasiswa['jurusan'] ?>">
            </div>
