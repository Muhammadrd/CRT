...
<body>
  ...
  <div class="container" style="margin-top: 20px; width:auto">
    <a href="/kelas/create"><button type="button" class="btn btn-success btn-sm">Tambah Data</button></a>
    <table class="table table-striped ">
      ...
      <?php foreach ($crud_kelas->items as $key => $value) { ?>
        <tr>
          ...
          <td>
            <a href="/kelas/<?= $value['id_mahasiswa'] ?>/show"><button type="button" class="btn btn-info btn-sm">Detail</button></a>
            <a href="/kelas/<?= $value['id_mahasiswa'] ?>/edit"><button type="button" class="btn btn-primary btn-sm">Edit</button></a>
            <a href="/kelas/<?= $value['id_kelas'] ?>/delete"><button type="button" class="btn btn-danger btn-sm">Hapus</button></a>
          </td>
        </tr>
      <?php } ?>
    </table>
