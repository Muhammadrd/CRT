    ...
    <div class="container" style="width: fit-content; margin-left:20px; width:500px;">
        ...
        <form action="/matakuliah/<?= $crud_matakuliah['id'] ?>/update" method="post">
            <div class="mb-3" style="margin-top: 10px;">
                <label for="mata_kuliah" class="form-label">Nama Matakuliah</label>
                <input type="text" class="form-control" name="mata_kuliah" aria-describedby="emailHelp" value="<?= $crud_matakuliah['mata_kuliah'] ?>">
            </div>
            <div class="mb-3">
                <label for="sks" class="form-label">Jumlah SKS</label>
                <input type="text" class="form-control" name="sks" value="<?= $crud_matakuliah['sks'] ?>">
            </div>
            <div class="mb-3">
                <label for="dosen" class="form-label">Dosen Pengampu</label>
                <input type="text" class="form-control" name="dosen" value="<?= $crud_matakuliah['dosen'] ?>" </div>
